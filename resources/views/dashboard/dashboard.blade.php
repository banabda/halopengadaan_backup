			...
			<div class="row">
				...
				<div class="col-xl-6 col-12">
					<div class="box bg-info bg-img" style="background-image: url(../images/gallery/bg-1.png)">
						<div class="box-body text-center">
							<img src="{{ asset('dashboard/') }}images/trophy.png" class="mt-50" alt="" />
          ...
          <div class="media-list media-list-hover mt-20">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-danger" href="#">
				<img src="{{ asset('dashboard/images/avatar/2.jpg') }}" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-warning" href="#">
				<img src="{{ asset('dashboard/images/avatar/3.jpg') }}" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-primary" href="#">
				<img src="{{ asset('dashboard/images/avatar/4.jpg') }}" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
				  <a class="hover-primary" href="#"><strong>Evan</strong></a>
