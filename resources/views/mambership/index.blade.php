              ...
              <div class="box-body">
                  ...
                  <div class="table-responsive" style="padding-top: 10px;">
                    ...
                    <tbody>
                      ...
                      <a href="{{ url('admin/deletemamber/'.$dt->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin mau menghapus data ini?')"><i class="fa fa-trash"></i> Delete</a>
                      </td>
                    </tr>
                  @endforeach
                  </table>
